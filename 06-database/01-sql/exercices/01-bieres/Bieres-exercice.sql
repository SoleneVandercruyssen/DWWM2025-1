...
-- TODO SELECT numero_ticket FROM ticket WHERE date_vente = '2014-01-15';

--  3. Afficher les tickets émis du 15/01/2014 au 17/01/2014.(4 résultats attendus)
--  TODO SELECT numero_ticket FROM ticket WHERE date_vente >= '2014-01-15' AND date_vente <= '2014-01-17';

--  4. Afficher la liste des articles apparaissant à 50 et plus exemplaires sur un ticket.(1274 résultats attendus)
-- TODO SELECT numero_ticket FROM ventes WHERE quantite >=50;

--  5. Quelles sont les tickets émis au mois de mars 2014.(78 résultats attendus)
--TODO SELECT numero_ticket FROM ticket WHERE date_vente BETWEEN '2014-03-01' AND '2014-03-31';
-- TODO SELECT numero_ticket FROM ticket WHERE date_vente >= '2014-03-01' AND date_vente <= '2014-03-31';

--  6. Quelles sont les tickets émis entre les mois de mars et avril 2014 ? (166 résultats attendus)
--TODO SELECT numero_ticket FROM ticket WHERE date_vente BETWEEN '2014-03-01' AND '2014-04-30';

--  7. Quelles sont les tickets émis au mois de mars et juin 2014 ? (174 résultats attendus)
--TODO SELECT numero_ticket FROM ticket WHERE date_vente BETWEEN '2014-03-01' AND '2014-03-31' OR date_vente BETWEEN '2014-06-01' AND '2014-06-30';
...
-- TODO SELECT id_article, nom_article FROM article ORDER BY id_couleur;

--  9. Afficher l’id et le nom des bières n’ayant pas de couleur. (706 résultats attendus)
--TODO SELECT id_article, nom_article FROM article WHERE id_couleur IS NULL;
