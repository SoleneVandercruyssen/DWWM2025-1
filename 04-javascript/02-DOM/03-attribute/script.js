<<<<<<< HEAD
"use strict"; 
// Permet de forcer l'indicateur de nous informer de nouvelles erreurs
...
/* 
    Une fois un élément HTML selectionné, nous pouvons modifier son attribut "style" afin d'y insérer du CSS.
        monElement.style.maPropriétéCSS
        h1.style.color
...
h1.style.textShadow = "5px 5px rbga(0,0,0,0.3)";
h1.style.fontSize = "5rem";

//  ! ATTENTION, Si on se trompe sur le nom d'une propriété, ou sur une valeur, JS ne provoquera pas 'erreur, mais n'appliquera aucun effet.
...
Soit className qui gère l'attribut class, comme un objet avec plusieurs fonctionnalités.*/

// Change tout l'attibut classe :
h1.className = "banane";
// Ajoute une classe :
...
// Par ex :  si je veux que l'id de mon élément :
console.log(h1.id, h1.getAttribute("id"));
// h1.attribute("id", h1.getAttribute("id")+"2");
h1.id += "2";
...
/* 
Les Data-attributs fonctionnent un peu différemment
On verra passer par "dataset" suivi d'un nom de l'attribut;
*/
...
a.dataset.blabla("Je ne sert à rien");
=======
// Vérifie la présence de la classe et retourne un boolean
console.log(h1.classList.contains("banane"));
