...
const   pass = document.querySelector('#pass'),
        passBis = document.querySelector('#passBis'),
        progress = document.querySelector('.progress');

passBis.addEventListener("change", checkBis);

function checkBis()
{
    if(pass.value === passBis.value)
    {
        passBis.style.backgroundColor = "";
        passBis.style.borderColor = "";
        return;
    }
    passBis.style.backgroundColor = "rgba(255, 0, 0, 0.5)";
    passBis.style.borderColor = "red";
}
