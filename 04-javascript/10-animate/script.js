...
// "?"" si c'est null je ne fais pas la suite, sans le "?" il indique dans la console une erreur
...
Les keyframes peuvent prendre deux formes, la première est un tableau d'objet.
    */
    const keyframes = [
    {left: 0, top: 0}, //Il commence à ...
    {left: "80%", top:"-200px"}, // Il se déplace de ...
    {left: "20%", top:"500px"} // Il termine par...
    ];
    const options = 
        {duration : 2000,
            iteration : 3,
...
function animation3() {
    // On peut récupérer l'objet "animate" afin d'avoir accés à de nouvelles fonctionnalités :
...
function animation2()
{
    ...
    div.animate(keyframes, {duration: 2000, direction: "alternate", iterations: 2});
}
function animation3()
{
    // On peut récupérer l'objet "animate" afin d'avoir accès à de nouvelles fonctionnalités :
    const anime = div.animate({transform: ["skew(0, 0)", "skew(360deg, 180deg"]}, {duration: 500, iterations: 1});
...
// const name = document.querySelector("#prénom")
// const work = document.querySelector("#métier")
// const otherside1 = document.querySelector("#nom")
// const otherside2 = document.querySelector("#web")
