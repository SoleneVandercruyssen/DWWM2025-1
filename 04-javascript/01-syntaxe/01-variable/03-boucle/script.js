...
let a = true;
/* 
    la boucle while () répètera ce qui se trouve entre accolade, tant que la condition entre paranthèse est vrai.
...
while(true)
{
    ...
    if(b < 10)
    {
        // Met fin à l'itération actuelle de la bouvle, pour passer à la suivante.
        continue;
    }
    if(b === 20)
    {
...
/* 
    do{}while() va exécuter ses intructions une première fois.
