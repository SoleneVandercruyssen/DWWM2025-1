"use strict";
// Un code sur une ligne
/* Alt shift a pour le racourcis 
Un commentaire 
...
let banane; 
// let est le mot le plus conseillé pour déclarer une variable.
console.log("Contenu de banane:", banane);
// * la fin d'une insctruction en JS, se fait soit par un saut à la ligne, soit par un ";".
var tomate; 
//  var était l'unique déclaration de variable avant 2016

const cerise = 5;
// const permet de déclarer une variable dont la valeur ne changera pas (ex: la date de naissance).
...

{
    ...
    // Les variables déclarés dans un bloc, sont accessibles depuis ce bloc et dans leurs enfants.
    {
        console.log(glet, gvar, hlet, hvar);
    }
}
...
// On utilise "typeof" pour connaître le type de variable qui suis: 
// type number, type boolean, type string, type object, type object, type undefined
...
// particuliarité de JS, les tableaux (array) sont des objects.
...
// ? Chaîne de cractères (string)
// ON peut déclarer nos strings avec 3 différente caractères "" '' ``
let s1 = "Coucou",
    s2 = 'Coucou',
    s3 = `Coucou`;


s1 = "L'apostrophe ne pose pas de pb ici";
s2 = 'L\'apostrophe ne pose pas de pb ici, je dois l\'échanger avec \\';
console.log(s1, s2);
...
// JS peut perdre précision avec les très grand nombre:
console.log(9_999_999_999_999);
...
// % représente un modulo qui est le reste de la division
/* ** représente une puissance, 2**3 signifie 2*2*2 */
...
// D'abord il envoi le contenu de la variable, puis il l'augmente.
console.log("n++", n++, "n", n);
// D'abord il augmente la variable, puis il envoi son contenu.
console.log("++n", ++n, "n", n);

n = 17;
// toString() permet de transformer un nombre en string.
console.log(n, n.toString());
// Il peut aussi changer sa base mathématique : En code binaire
...
// Deux façon de déclarer un tableau
const a1 = [5, "truc", true];
const a2 = new Array(5, "truc", true);
console.log(a1, a2);
/* 
...
*/
console.log(a1[1]);
// la propriété ".lenght" permet de connaître la taille d'un tableau
console.log(a1.length);
// Récuperer le dernier élément d'un tableau de longueur inconnue : 
...
/* 
    ...
    Le second, le nombre d'éléments à supprimer.
...
// donc en indiquant ici a a4 = a1, ce n'est pas le contenu du tableau recopié, mais l'addresse.
// Par ce FinalizationRegistry, modifier l'une des variables, modifiera le tableau pour les deux variable.
// const a4 = a1;
// console.log(a4);

a4.push("Copie de a1");
;// Pour obtenir une copie, on devra utiliser le spread opreator(...)
console.log(a4, a1);
// console.log(a1, ...a1);
console.log(a1, ...a1);
// console.log(a1[0], a1[1], a1[2], a1[4], );
const a5 = [...a1];
console.log(a5);
a5.unshift("Vrai copie !")
console.log(a5, a1);

// Un tableau multidimensionnel, est un tableau qui en contient un autre
const a6 = ["voiture", "avion", ["chaussette", "banane"]];
console.log(a6);
// Pour sélectionner un élément dans un tableau multidimensionnel, je demande d'abord l'index du second tableau, puis l'index de l'élément que je souhaite afficher :
console.log(a6[2] [0]);
...
/* 
Les objets ont des "propriétés" qui sont des mots suivi de ":" et dans ses propriétés, on place des "valeurs" qui peuvent être n'importe quoi (string, number, array..)
*/
...
// Il existe plusieurs façon de les faire apparaître, par ex avec des comparaisons :

// Plus petit au plus grand
console.log("1 < 2", 1 < 2);
console.log("1 > 2", 1 > 2);

// plus "grand ou égale" ou "plus petit ou égale"
console.log("1 >= 2", 1 >= 2);
console.log("1 <= 2", 1 <= 2);
...
// Pour obtenir "true" avec OR(||) il faut qu'au moins un côté soit "true"
console.log(true || true, true || false, false || false);
