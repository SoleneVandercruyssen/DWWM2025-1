...
const t1 = document.getElementById("tel")
const t2 = /^[0-9]*$/;
t1.addEventListener("change", t)
...
const m1 = document.getElementById("mail")
const m2 =/@/;
m1.addEventListener("change", m)
...
// ! EXO 4 :
    ...
    div.addEventListener("change", exercice4);
// // Revient à zéro 
//     if (div.length === 0) {
...
if (new RegExp(Array[1]).test(password))
    passed++; {
}
...
p2.addEventListener("change", motdepasse)
